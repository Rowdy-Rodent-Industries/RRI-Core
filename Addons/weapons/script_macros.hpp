...
#define AMMOTYPE_MEDICAL 1
#define AMMOTYPE_TRACKING 2
#define AMMOTYPE_ACID 3
#define AMMOTYPE_HACKSHOT 4
#define AMMOTYPE_RAIL 5
#define AMMOTYPE_BEANBAG 6
#define AMMOTYPE_DEFIB 7
#define AMMOTYPE_DROPPOD 8
#define AMMOTYPE_FIRE 9
