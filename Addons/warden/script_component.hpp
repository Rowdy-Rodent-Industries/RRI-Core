#define COMPONENT warden
#define COMPONENT_BEAUTIFIED Warden
...
#ifdef DEBUG_ENABLED_WARDEN
    #define DEBUG_MODE_FULL
#endif

#ifdef DEBUG_SETTINGS_WARDEN
    #define DEBUG_SETTINGS DEBUG_SETTINGS_WARDEN
#endif
